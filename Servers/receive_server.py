...
class App(QWidget):
    ...
    def __init__(self):
        ...
        self.worker.signals.received_text.connect(self.set_text)
        self.worker.signals.received_record.connect(self.set_record)
        self.worker.signals.received_image.connect(self.set_image)
        self.worker.start()
